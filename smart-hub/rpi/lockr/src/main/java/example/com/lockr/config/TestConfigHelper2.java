...
/**
 * Container for methods to set SDK environment before running unit+integration
 * tests
 *
 */
public class TestConfigHelper2 {
	...
	/**
	 * clearCaConfig "resets" Config used by fabric_ca so that the Config testcases
	 * can run without interference from other test suites.
	 *
	 * @throws SecurityException
	 * @throws NoSuchFieldException
	 * @throws IllegalAccessException
